...
export default function Workspace() {
    ...
    return (<>
        <div style={{"display": "grid", "height": "90vh"}}>
            <img src="mansion.jpg" style={{"width": "100%", "height": "90vh", "objectFit": "cover", "objectPosition": "50% 50%", "position": "absolute", "zIndex": "-1", "filter": "brightness(80%)"}}></img>
        ...
        <div style={{"display": "grid", "width": "1235px", "marginLeft": "auto", "marginRight": "auto", "height": "400px"}}>
            ...
            <div style={{"display": "grid", "gridTemplateColumns": "33% 33% 33%", "width": "100%", "marginTop": "-120px"}}>
                <div style={{"display": "grid"}}>
                    <img src="house1.jpg" className="testing"></img>
                ...
                <div style={{"display": "grid"}}>
                    <img src="house2.jpg" className="testing"></img>
                ...
                <div style={{"display": "grid"}}>
                    <img src="house3.jpg" className="testing"></img>
        ...
        <div style={{"display": "grid", "width": "1235px", "marginLeft": "auto", "marginRight": "auto"}}>
            ...
            <div style={{"display": "grid", "gridTemplateColumns": "50% 50%", "marginBottom": "40px"}}>
                <img src="counter.jpg" style={{"width": "90%", "marginLeft": "auto", "marginRight": "auto"}}></img>
            ...
            <div style={{"display": "grid", "gridTemplateColumns": "50% 50%", "marginBottom": "40px"}}>
                ...
                <img src="interor.jpg" style={{"width": "90%", "marginLeft": "auto", "marginRight": "auto"}}></img>
            </div>
            <div style={{"display": "grid", "gridTemplateColumns": "50% 50%", "marginBottom": "40px"}}>
                <img src="window.jpg" style={{"width": "90%", "marginLeft": "auto", "marginRight": "auto"}}></img>
                <div style={{"display": "grid", "gridTemplateRows": "50% 50%"}}>
